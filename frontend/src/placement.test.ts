...
import { canSupportItems, liftToSupport, isAnchored, settleItem, settleScene } from './placement.ts'
...
test('legacy normalization settles unsupported locked furniture without unlocking it', () => {
  ...
  assert.equal(normalized.scene.items[0].elevation, 0)
