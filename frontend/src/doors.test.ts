...
import { filterProducts, initialCatalog, parseProduct, validPlacement } from './catalog.ts'
import type { Item, Product, Scene } from './catalog.ts'
import { doorClearance, doorGeometry, doorOpenings, normalizeDoor, validDoorAnchor, validDoors } from './doors.ts'
import { isAnchored, settleItem, settleScene, validItemGeometry } from './placement.ts'
